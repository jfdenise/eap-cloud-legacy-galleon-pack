...
# For EAP we want standalone-openshift.xml, for now we use standalone.xml to be usable with 6.0.0.Beta1 bootable JAR plugin
WILDFLY_SERVER_CONFIGURATION=standalone.xml
